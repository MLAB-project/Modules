...
//horni zavit
    ...
    translate ([0,0,-0.01])
        cylinder (h=D03_vyska_zavitu+0.02 ,r= D03_polomer_zavitu -D03_tolerance_zavitu- D03_material_za_zavitem-1.5 ,$fn=100);
...
//materiál pod horním závitem
     translate ([0,0,D03_vyska_stitu-D03_tloustka_materialu])
    difference () {
    translate ([0,0,0])
        cylinder (h=D03_tloustka_materialu ,r=D03_polomer_zavitu -D03_tolerance_zavitu- D03_material_za_zavitem+D03_tloustka_materialu ,$fn=100);
            
            
     translate ([0,0,-0.01])
        cylinder (h=D03_tloustka_materialu+0.02 ,r= D03_polomer_zavitu -D03_tolerance_zavitu- D03_material_za_zavitem-1.5 ,$fn=100);        
...
//screen
     ...
     translate ([0,0,3*D03_tloustka_materialu])
    difference () {
        cylinder (h=D03_vyska_stitu-3*D03_tloustka_materialu,r1=D03_polomer_stitu ,r2=D03_polomer_zavitu -D03_tolerance_zavitu- D03_material_za_zavitem-1.5,$fn=100);
        translate ([0,0,-0.01/2-D03_tloustka_materialu])
...
for (i = [0 : (D03_pocet_vyztuh-1)]) {
	...
	polygon(points=[[D03_polomer_zavitu- D03_material_za_zavitem-D03_tolerance_zavitu-1.5,D03_vyska_stitu],[D03_polomer_zavitu, 0],[D03_polomer_stitu - D03_tloustka_materialu,0],[D03_polomer_stitu- D03_tloustka_materialu,3*D03_tloustka_materialu]]);
